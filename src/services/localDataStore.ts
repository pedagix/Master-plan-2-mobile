...
function exportFullBackup(data) {
  downloadJson({ ...migrateData(data), meta: { ...(data.meta || {}), appName: 'Master Plan', schemaVersion: 8, exportType: 'full-backup', exportedAt: new Date().toISOString() } }, 'master-plan-full-backup');
}
